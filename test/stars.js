...
var stars = new Array(
  ...
  new starcat("b","AUR","Menkalinan","05:59:32","+44:57:00","190","SD","A2"),
  new starcat("z","AUR","Capella","05:02:29","+41:05:00","000","SS","K5"),
...
function doStars(obs) {
  ...
  with (swin.document) {
    ...
    for (var i=0; i<stars.length; i++) {
      ...
      writeln("<TR><TD align=center>"+stars[i].star+"</TD>");
      writeln("<TD align=center>"+stars[i].cons+"</TD>");
